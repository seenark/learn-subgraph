...
import { Blog } from '../../typechain-types/Blog'
...
export default function Post() {
  ...
  async function fetchPost() {
    ...
    const contract = new ethers.Contract(contractAddress, BlogAbi.abi, provider) as Blog
    const val = await contract.fetchPost(id as string)
  ...
  async function updatePost() {
    ...
    const contract = new ethers.Contract(contractAddress, BlogAbi.abi, signer) as Blog
