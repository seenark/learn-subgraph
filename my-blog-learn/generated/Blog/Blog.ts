...
export class Blog__fetchAllPostResultValue0Struct extends ethereum.Tuple {
  get id(): BigInt {
...
export class Blog extends ethereum.SmartContract {
  ...
  fetchAllPost(): Array<Blog__fetchAllPostResultValue0Struct> {
    let result = super.call(
      "fetchAllPost",
      "fetchAllPost():((uint256,string,string,bool)[])",
      []
    );

    return result[0].toTupleArray<Blog__fetchAllPostResultValue0Struct>();
  }

  try_fetchAllPost(): ethereum.CallResult<
    Array<Blog__fetchAllPostResultValue0Struct>
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Blog__fetchAllPostResultValue0Struct>()
    );
  }
...
export class UpdateBlogNameCall extends ethereum.Call {
  get inputs(): UpdateBlogNameCall__Inputs {
    return new UpdateBlogNameCall__Inputs(this);
  }

  get outputs(): UpdateBlogNameCall__Outputs {
    return new UpdateBlogNameCall__Outputs(this);
  }
}

export class UpdateBlogNameCall__Inputs {
  _call: UpdateBlogNameCall;

  constructor(call: UpdateBlogNameCall) {
    this._call = call;
  }
...
export class UpdateBlogNameCall__Outputs {
  _call: UpdateBlogNameCall;
